...
<template>
  <div
    class="language-ts vp-adaptive-theme transition-none! mini-playground"
    shadow
  ...
  >
    ...
    >
      ...
      >
        ...
        <FundingButton
          :name="`${currentLang?.displayName} grammar`"
          :funding="currentLang?.funding"
        />
      </label>
      <label
        relative
      ...
      >
        ...
        >
          <option
            v-for="theme in play.allThemes.filter((i) => i.type === 'light')"
            :key="theme.name"
            :value="theme.name"
          >
            {{ theme.displayName }}
          ...
          <option
            v-for="theme in play.allThemes.filter((i) => i.type === 'dark')"
            :key="theme.name"
            :value="theme.name"
          >
            {{ theme.displayName }}
