...
} from "../../packages/transformers/src";
...
const REFERENCES = [
  ...
  {
    text: "JavaScript Engine Compatibility",
    link: "/references/engine-js-compat",
  },
] as const satisfies (
  | DefaultTheme.NavItemWithLink
  | DefaultTheme.SidebarItem
...
const BLOGS: DefaultTheme.NavItemWithLink[] = [
  ...
  {
    text: "The Evolution of Shiki v1.0",
    link: "https://nuxt.com/blog/shiki-v1",
  },
];
...
const VERSIONS: (
  ...
  {
    text: `Contributing`,
    link: "https://github.com/shikijs/shiki/blob/main/CONTRIBUTING.md",
  },
  {
    items: [
      ...
      {
        text: "Migration from v0.14",
        link: "/guide/migrate#migrate-from-v0-14",
      },
      {
        text: "Migration from Shikiji",
        link: "/guide/migrate#migrate-from-shikiji",
      },
    ],
  },
];
  ...
  withMermaid(
    defineConfig({
          ...
          }),
          {
            ...
            preprocess(code, options) {
              ...
              if (themes.length === 1) {
                ...
                throw new Error(
                  `Only 1 or 2 themes are supported, got ${themes.length}`,
                );
              }
              return code;
            },
      ...
      head: [
        ...
        [
          "meta",
          { property: "og:image", content: "https://shiki.style/og.png" },
        ],
        [
          "meta",
          {
            property: "og:description",
            content: "A beautiful yet powerful syntax highlighter",
          },
        ],
        ["meta", { name: "twitter:card", content: "summary_large_image" }],
        [
          "meta",
          { name: "twitter:image", content: "https://shiki.style/og.png" },
        ],
        [
          "meta",
          {
