...
it("includeExplanation", async () => {
  ...
  const caseFalse = await codeToTokensBase(engine, code, {
    lang: "js",
    theme: "vitesse-dark",
    includeExplanation: false,
  });
  const caseTrue = await codeToTokensBase(engine, code, {
    lang: "js",
    theme: "vitesse-dark",
    includeExplanation: true,
  });
  const caseScopeName = await codeToTokensBase(engine, code, {
    lang: "js",
    theme: "vitesse-dark",
...
describe("defaultColor light-dark()", () => {
  ...
  it("should throw when no light or dark theme is provided", async () => {
    ...
    expect(() => {
      ...
      `[ShikiError: When using \`defaultColor: "light-dark()"\`, you must provide both \`light\` and \`dark\` themes]`,
    );
