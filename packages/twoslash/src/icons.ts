...
export const defaultCompletionIcons: Record<string, Element | undefined> =
  completionIcons as any;
export const defaultCustomTagIcons: Record<string, Element | undefined> =
  tagIcons as any;
