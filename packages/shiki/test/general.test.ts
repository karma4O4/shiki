...
describe("should", () => {
  it("works", async () => {
    ...
    expect(
      ...
      `"<pre class="shiki vitesse-light" style="background-color:#ffffff;color:#393a34" tabindex="0"><code><span class="line"><span style="color:#B07D48">console</span><span style="color:#999999">.</span><span style="color:#B07D48">log</span></span></code></pre>"`,
    );
  });
  ...
  it("dynamic load theme and lang", async () => {
    ...
    expect(shiki.getLoadedLanguages()).toMatchInlineSnapshot(`
        [
          "javascript",
          "typescript",
          "python",
      ...
      `);
    expect(shiki.getLoadedThemes()).toMatchInlineSnapshot(`
        [
          "vitesse-light",
          "min-dark",
        ]
    ...
    expect(
      shiki.codeToHtml("print 1", { lang: "python", theme: "min-dark" }),
    ).toMatchInlineSnapshot(
      `"<pre class="shiki min-dark" style="background-color:#1f1f1f;color:#b392f0" tabindex="0"><code><span class="line"><span style="color:#B392F0">print </span><span style="color:#F8F8F8">1</span></span></code></pre>"`,
    );
  });
  ...
  it("requires nested lang", async () => {
    ...
    expect(shiki.getLoadedLanguages().sort()).toMatchInlineSnapshot(`
        [
          "cjs",
          "css",
          "cts",
  ...
  it("dynamic load theme and lang with md", async () => {
    ...
    expect(shiki.getLoadedLanguages().length).toMatchInlineSnapshot(`10`);
    ...
    expect(
      shiki.codeToHtml("console.log(1)", { lang: "js", theme: "min-dark" }),
    ).toMatchInlineSnapshot(
      `"<pre class="shiki min-dark" style="background-color:#1f1f1f;color:#b392f0" tabindex="0"><code><span class="line"><span style="color:#79B8FF">console</span><span style="color:#B392F0">.log(</span><span style="color:#F8F8F8">1</span><span style="color:#B392F0">)</span></span></code></pre>"`,
    );
  ...
  it("dynamic load lang with vue", async () => {
    ...
    expect(shiki.getLoadedLanguages()).not.includes("scss");
    ...
    const html1 = shiki.codeToHtml(code, {
      lang: "vue",
      theme: "vitesse-dark",
    });
    ...
    expect(shiki.getLoadedLanguages()).includes("scss");

    const html2 = shiki.codeToHtml(code, {
      lang: "vue",
      theme: "vitesse-dark",
    });
  ...
  it("monokai underline", async () => {
    await expect(
      await codeToHtml("type Foo = { bar: string }", {
        theme: "monokai",
        lang: "ts",
      }),
  ...
  it("skip line tokenizing", async () => {
    ...
    expect(
      await codeToHtml(`const long = ${longText}`, {
        theme: "vitesse-light",
        lang: "javascript",
      }),
    ).toMatchInlineSnapshot(
      `"<pre class="shiki vitesse-light" style="background-color:#ffffff;color:#393a34" tabindex="0"><code><span class="line"><span style="color:#AB5959">const</span><span style="color:#B07D48"> long</span><span style="color:#999999"> =</span><span style="color:#B07D48"> ${longText}</span></span></code></pre>"`,
    );

    expect(
      await codeToHtml(`const short = ""\nconst long = ${longText}`, {
        theme: "vitesse-light",
        lang: "javascript",
...
describe("errors", () => {
  it("throw on invalid theme", async () => {
    await expect(() =>
      ...
      `[ShikiError: Theme \`invalid\` is not included in this bundle. You may want to load it from external source.]`,
    );
  });
  ...
  it("throw on invalid lang", async () => {
    await expect(() =>
      ...
      `[ShikiError: Language \`invalid\` is not included in this bundle. You may want to load it from external source.]`,
    );
  });
});
