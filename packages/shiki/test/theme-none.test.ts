...
describe("none theme", () => {
  it("works", async () => {
    ...
    expect(
      shiki.codeToHtml("console.log", { lang: "js", theme: "none" }),
    ).toMatchInlineSnapshot(
      `"<pre class="shiki none" style="background-color:;color:" tabindex="0"><code><span class="line"><span>console.log</span></span></code></pre>"`,
    );
  });
